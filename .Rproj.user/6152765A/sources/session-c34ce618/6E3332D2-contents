...
Using a comprehensive set of demographic, tumor, and treatment variables, PREDICTbreastML estimates 10-year breast cancer–specific, other-cause, and all-cause mortality, and provides individualized projections of chemotherapy benefit. Our evaluation shows that population-level recalibration, sample reweighting, and treatment-effect adjustment yield substantial improvements in accuracy and subgroup performance across racial and ethnic groups.
